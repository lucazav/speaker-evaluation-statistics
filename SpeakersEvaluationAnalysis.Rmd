...
####################################
#  INPUT VARIABLES IN EXCEL FILES  #
####################################
...
The following is the ticket for feedbacks:
...
```{r speaker-details, results='asis', fig.width=10, fig.height=10, message=FALSE, echo=FALSE}
